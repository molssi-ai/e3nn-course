...
- Geiger & Smidt, *e3nn: Euclidean Neural Networks* (2022) — [Geiger arXiv 2207.09453 2022](https://arxiv.org/pdf/2207.09453)
- Thomas et al., *Tensor Field Networks* (2018) — [Thomas arXiv 1802.08219 2018](https://arxiv.org/pdf/1802.08219)
- Weiler et al., *3D Steerable CNNs* (NeurIPS 2018) — [Weiler NeurIPS 2018](https://proceedings.neurips.cc/paper_files/paper/2018/file/488e4104520c6aab692863cc1dba45af-Paper.pdf)
- Battaglia et al., *Relational inductive biases and graph networks* (2018) — [Battaglia arXiv 1806.01261 2018](https://arxiv.org/pdf/1806.01261)
- Fuchs et al., *SE(3)-Transformers* (NeurIPS 2020) — [Fuchs NeurIPS 2020](https://proceedings.neurips.cc/paper_files/paper/2020/file/15231a7ce4ba789d13b722cc5c955834-Paper.pdf)
- Anderson et al., *Cormorant* (NeurIPS 2019) — [Anderson NeurIPS 2019](https://proceedings.neurips.cc/paper_files/paper/2019/file/03573b32b2746e6e8ca98b9123f2249b-Paper.pdf)
- Liao & Smidt, *Equiformer* (ICLR 2023) — [Liao ICLR 2023](https://arxiv.org/pdf/2206.11990)

**Equivariant interatomic potentials**

- Batzner et al., *NequIP: E(3)-equivariant GNNs for interatomic potentials* (Nat. Commun. 2022) — [Batzner Nat. Commun. 13 2453 2022](https://doi.org/10.1038/s41467-022-29939-5)
- Musaelian et al., *Allegro: local equivariant representations* (Nat. Commun. 2023) — [Musaelian Nat. Commun. 14 579 2023](https://doi.org/10.1038/s41467-023-36329-y)
- Batatia et al., *MACE* (NeurIPS 2022) — [Batatia NeurIPS 2022](https://proceedings.neurips.cc/paper_files/paper/2022/file/4a36c3c51af11ed9f34615b81edb5bbc-Paper-Conference.pdf)
- Batatia et al., *The design space of E(3)-equivariant atom-centred potentials* — [Batatia arXiv 2205.06643 2022](https://arxiv.org/pdf/2205.06643) / [Batatia Nat. Mach. Intell. 7 56 2025](https://doi.org/10.1038/s42256-024-00956-x)
- Kovács et al., *Evaluation of MACE* (2023) — [Kovacs J. Chem. Phys. 159 044118 2023](https://doi.org/10.1063/5.0155322)
- Kovács et al., *MACE-OFF* — [Kovacs J. Am. Chem. Soc. 147 17598 2025](https://doi.org/10.1021/jacs.4c07099)
- Batatia et al., *MACE-MP-0 foundation model* (2023) — [Batatia arXiv 2401.00096 2024](https://arxiv.org/pdf/2401.00096)

**Atomic Cluster Expansion & theory**

- Drautz, *Atomic cluster expansion* (PRB 2019) — [Drautz Phys. Rev. B 99 014104 2019](https://doi.org/10.1103/PhysRevB.99.014104)
- Dusson et al., *ACE: completeness, efficiency, stability* (2022) — [Dusson J. Comput. Phys. 454 110946 2022](https://doi.org/10.1016/j.jcp.2022.110946)
- Nigam et al., *Unified theory of atom-centered representations and message passing* (JCP 2022) — [Nigam J. Chem. Phys. 156 204115 2022](https://doi.org/10.1063/5.0087042)
- Pozdnyakov & Ceriotti, *Incompleteness of GNNs for point clouds* — [Pozdnyakov arXiv 2201.07136 2022](https://arxiv.org/pdf/2201.07136)
- *Resolving the body-order paradox of MLIPs* (2026) — [Chong J. Chem. Phys. 164 064121 2026](https://doi.org/10.1063/5.0303302)

**Long-range interactions & periodic systems**

- Grisafi & Ceriotti, *Incorporating long-range physics* (JCP 2019) — [Grisafi J. Chem. Phys. 151 204105 2019](https://doi.org/10.1063/1.5128375)
- Kosmala et al., *Ewald-based message passing* (2023) — [Kosmala ICML 2023](https://proceedings.mlr.press/v202/kosmala23a.html)
- *Latent Ewald summation* — [Cheng npj Comput. Mater. 11 80 2025](https://doi.org/10.1038/s41524-025-01577-7)
- Kolafa & Perram, *Cutoff errors in Ewald summation* (1992) — [Kolafa Mol. Simul. 9 351 1992](https://doi.org/10.1080/08927029208049126)
